...
public class EditBioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.includeLayout.editLabelTv.setVisibility(view.INVISIBLE);
        binding.includeLayout.editValueTv.setText(user.getBio());
        return view ;
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        binding.includeLayout.editLabelTv.setVisibility(getView().VISIBLE);
        binding = null;
    }
}